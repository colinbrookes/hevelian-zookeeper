...
public class Configuration {
	...
	public Configuration(String home) {
		...
		try {
			...
			if(contextHome==null) {
				System.out.println("HevelianZookeeper: JNDI "+home+" not correctly configured in context.xml.");
				return;
			}
			...
			System.out.println("HevelianZookeeper: JNDI "+home+" exception: " + e.getMessage());
		}
	}
